    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="<?=base_url("Simpan/index")?>" class="nav-link "><span class="pcoded-micon"><i class="fa fa-cog"></i></span><span class="pcoded-mtext">Simpan</span></a>
                </li>
                <li class="nav-item">
                    <a href="<?=base_url("Pinjam/index")?>" class="nav-link "><span class="pcoded-micon"><i class="fa fa-user"></i></span><span class="pcoded-mtext">Pinjam</span></a>
                </li>
